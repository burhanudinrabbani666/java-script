...
function slider() {
  ...
  function goToSlide(InitialSlide) {
  ...
  dotContainer.addEventListener("click", function (event) {
    if (event.target.classList.contains("dots__dot")) {
      const currSlide = Number(event.target.dataset.slide);
